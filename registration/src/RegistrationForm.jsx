      ...
      <div className="h-full w-full max-w-2xl mx-auto flex flex-col p-6 md:p-8 overflow-y-auto">
        ...
        >
          {({ isValid, dirty, touched, errors }) => (
            <Form className="space-y-5 bg-gradient-to-b from-gray-800/30 to-black/30 p-6 md:p-8 rounded-xl border border-orange-900/20 shadow-xl">
              <div>
              ...
              <div>
                ...
                <Field
                  ...
                  type="date"
                  name="datum"
                  className={`${inputClasses} ${touched.datum && errors.datum ? 'border-orange-500' : ''}`}
                />
